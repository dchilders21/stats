...
VERSION = "t2"
#ID = "4738bfae-fda8-4489-83c7-ab1284909336"

cursor = cnx.cursor(buffered=True)
query = ("SELECT id, stats_id FROM matches WHERE stats_id = '7f49b917-075f-491e-8cf6-7bd28f0368a8'")
...
for id, stats_id in matches:
    ...
    add_coverage = ("INSERT INTO match_coverage "
                "(lineups, tactical_lineups, corner_facts, extended_facts, deep_facts, statistics, match_id) "
    ...
    data_home_team_coverage = (
        home["id"], home["formation"], home["score"], home["regular_score"], home["penalty_score"], home["winner"],
    ...
    data_away_team_coverage = (
        away["id"], away["formation"], away["score"], away["regular_score"], away["penalty_score"], away["winner"],
    ...
    for player in home_players:
        ...
        data_home_player = (
            player["id"], player["position"], player["started"], player["jersey_number"], tactical_position, tactical_order,
